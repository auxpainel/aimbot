...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/auxpainel/aimbot/refs/heads/main/prompt.lua')
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/auxpainel/aimbot/refs/heads/main/icones.lua')
-- Variables
